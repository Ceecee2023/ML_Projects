...
raw.data <- readr::read_csv('https://maguire-lab.github.io/health_data_science_research_2024/static_files/practicals/lab1_data/2016_05v2_VitoriaAppointmentData.csv')
```
...
Based on the EDA, many features seem to be obviously related to no show. Therefore, I think the accuracy of the model should be very high.
...
plot(rf_var_importance, main = "Variable Importance for Random Forest Model")
...
According to the above indicators, in terms of feature importance, it is very close to our previous ideas and more reasonable, but the model still has many problems:
1.Class Imbalance: A high prevalence of positive classes (No) indicates severe class imbalance, reflected in low specificity and moderate balanced accuracy.
